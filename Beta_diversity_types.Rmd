...
We can now create a data frame with all the pairwise distances, together with the couple of categories they belong to. It is then stored in the object `df_plot`, which will then be used for plotting.
